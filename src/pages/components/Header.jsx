...
const navigation = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/buenosairestransfer/',
      icon: (props) => (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/catherine_fulop/status/894895063184007169',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/FrancoPandiani/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
          ...
          <div>
            <div>
              <h1 className="text-4xl font-semibold tracking-tight pb-16 ">
                Buenos Aires Transfer <span> </span>
                <Typewriter
                  words={['transporte', 'vip', 'para turistas', 'para ti !']}
                  loop={0}
                  cursor
                  cursorStyle="_"
                  typeSpeed={120}
              ...
              <div className=" max-w-4xl leading-8 space-x-4">
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                  <Link href="/zones">Nuestros Servicios</Link>
                </span>
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                ...
                <div className="hidden absolute bottom-4 left-4 lg:flex space-x-6 xl:mx-12 mx-0">
                  {navigation.social.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="text-gray-900 dark:text-white hover:text-gray-800"
                    >
            ...
            <div className="absolute inset-x-0 top-[calc(100%-20rem)] -z-10 transform-gpu overflow-hidden bg-gray-500 blur-xl lg:top-[calc(100%-45rem)] sm:top-[calc(100%-30rem)]">
              <Image
                width={1024}
                height={1024}
                alt=""
                src="https://di-uploads-pod9.dealerinspire.com/sullivanparkhillautomotiveinc/uploads/2018/04/MB-A-class-Background.jpg"
