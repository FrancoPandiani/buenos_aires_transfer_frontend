...
const customerHelpLinks = [
  {
    ...
    description: 'Learn how to get started with Buenos Aires Transfer.',
  },
  {
    link: '/help/id',
    icon: UserIcon,
  ...
  },
  {
    ...
    description: 'Everything about learning on Buenos Aires Transfer.',
  },
  {
    link: '/help/id',
  ...
  },
  {
    ...
    title: 'Mobile',
    description: 'Learn about the Buenos Aires Transfer app.',
  },
  {
    link: '/help/id',
    icon: LockClosedIcon,
...
const sellerLinks = [
  ...
  { text: 'Selling on Buenos Aires Transfer: FAQ', path: '/help/id' },
];
...
const sellerHelpLinks = [
  ...
  },
  {
    ...
    description: 'Learn about announcements and promotions by Buenos Aires Transfer.',
  },
  {
    link: '/help/id',
    icon: CheckIcon,
