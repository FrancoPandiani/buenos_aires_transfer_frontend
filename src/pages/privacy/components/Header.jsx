      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
            Buenos Aires Transfer ("nosotros" o "nuestro") opera los sitios web https://www.buenosairestransfer.com (el
            "Servicio").
          </p>
          <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
            ...
            privacidad, accesible desde http://www.buenosairestransfer.com/privacy
          </p>
        </div>
      </div>
    </div>
