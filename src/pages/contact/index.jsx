...
const navigation = {
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/buenosairestransfer',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://www.github.com/francopandiani',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900 dark:text-dark-txt">
                  <div className="absolute left-30 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-cyan-600">
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-center lg:mt-24">
