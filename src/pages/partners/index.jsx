...
const SeoList = {
  title: 'Our Partners - Buenos Aires Transfer NFT Marketplace',
  description:
    'Discover our partners at Buenos Aires Transfer, the ultimate NFT marketplace for online courses, physical products, and more. Learn about our collaborations with leading brands and creators in the NFT space.',
  href: '/',
  url: 'https://Buenos Aires Transfer.com',
  keywords: 'Buenos Aires Transfer partners',
  robots: 'all',
  author: 'Buenos Aires Transfer',
  publisher: 'Buenos Aires Transfer',
  image:
    'https://bafybeiaor24mrcurzyzccxl7xw46zdqpor4sfuhddl6tzblujoiukchxnq.ipfs.w3s.link/friends.png',
  twitterHandle: '@Buenos Aires Transfer',
};
